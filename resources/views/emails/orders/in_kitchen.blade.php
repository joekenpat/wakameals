...
Hurray!
Your order:  **`{{$order->code}}`** is currently being prepared by the chef. To monitor the status of your order kindly login to your account here and check the order status.
