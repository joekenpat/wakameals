...
export default function ClosedOder() {
  ...
  useEffect(() => {
    ...
    Axios.get("/api/order/list/closed", {
      headers: {
      ...
      {loading ? (
        ...
        <div className="mt-5 container">
          {orders.data.length > 0 ? (
                        ...
                        <span
                          className={`badge ${
                            data.status === "completed"
                              ...
                              ? "badge-secondary"
                              : data.status === "cancelled_failed_payment"
                              ? "badge-warning"
                              : data.status === "cancelled_system"
                              ? "badge-primary"
              ...
              {typeof orders.next_url === "string" && (
                ...
                >
                  {loading1 ? (
                    ...
                    <button
                      onClick={seeMore}
                      className="cursor btn btn-style"
            ...
            <div
              style={{ fontWeight: "bold", color: "#ff7417" }}
