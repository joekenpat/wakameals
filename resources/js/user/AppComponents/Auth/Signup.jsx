    ...
    <div>
      ...
      >
        <div
          ...
          style={{ backgroundColor: "#ff7417", width: "60%" }}
        >
            ...
            <from>
              <div className="from-row">
                ...
                <div className="form-group col-md-12">
                  ...
                  {error && (
                    <p style={styles.formError}>{error.errors.email}</p>
                  )}
                  {error && (
                    <p style={styles.formError}>{error.errors.phone}</p>
                  )}
                  {error && (
                    <p style={styles.formError}>{error.errors.username}</p>
                  )}
                </div>
                <div className="form-group col-md-12">
                  ...
                  />
                  {error && (
                    <p style={styles.formError}>{error.errors.password}</p>
                  )}
                </div>
                {loading ? (
                ...
                <div className="form-group col-md-12">
                  <Link
                    to="/signin"
                    className="btn"
                    style={{ color: "#023a9c", fontWeight: "bold" }}
                  >
