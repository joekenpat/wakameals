...
class DispatcherSearch
{
  public static function apply(Request $filters, $per_page = 20)
  {
    $query = static::applyDecoratorsFromRequest($filters, (new Dispatcher)->newQuery());
    return static::getResults($query, $per_page);
  }

  private static function applyDecoratorsFromRequest(Request $request, Builder $query)
  {
    $validFilterNames = Dispatcher::filterables;
  ...
  {
    return __NAMESPACE__ . '\\DispatcherFilters\\' . Str::studly($name);
  }
